...
#include <cctype>
#include <fstream>
#include <cstdio>      // 必须包含，否则 printf 未定义
using namespace std;
...
enum TextID {
    ...
    TXT_LANG_PROMPT,
    TXT_HELP_LANG,        // 新增：帮助菜单里漏掉了 LANG
    TXT_COUNT
};
...
void InitTexts() {
    ...
    texts[TXT_VER_INFO + LANG_ZH_CN] = "Tool-Box 2.0.0-beta";
    ...
    texts[TXT_VER_INFO + LANG_EN_US] = "Tool-Box 2.0.0-beta";
